...
public class ProductServiceSubCategoryVO extends RequestVO {

    private int id;
    private int productCategoryId;

    @Size(max = VariableSize.NAME_SIZE, message = ValidationMessages.Product_Service_Category_Name_Length)
    @Pattern(regexp = ValidationRegEx.Character_Pattern, message = ValidationMessages.Product_Service_Category_Name_Format)
